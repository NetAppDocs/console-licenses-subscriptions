...
summary: View contract details for each of your on-premises ONTAP clusters. 
---
...
[.lead]
In the NetApp Console, you can discover an ONTAP cluster and view contract details for each on-premises ONTAP cluster you've discovered. 
