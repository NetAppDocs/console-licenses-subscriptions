...
NOTE: To enter the serial number, first https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-nss-accounts.html[add your NetApp Support Site account to the Console^]. This NSS account must be authorized to access the serial number.
