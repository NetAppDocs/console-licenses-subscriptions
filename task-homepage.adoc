...
[.lead]
The *Overview* dashboard in the NetApp Console helps you monitor the statuses of your licenses and subscriptions to ensure that you can manage costs and maintain service as subscriptions reach expiration dates or capacity limits. 

You can view specific license and subscription information about each of your data services (including Cloud Volumes ONTAP). 

The Licenses and subscriptions dashboard alerts you to upcoming capacity limits or expirations, prompting you to take the requisite action. 

=== View details about a specific data service

The *Overview* dashboard provides details about the following services:
...
+ 
You can't add new licenses or subscriptions from the *Overview* page for a specific service. You can only add licenses from the *Direct licenses* tab or subscriptions from the *Marketplace subscriptions* tab.
+ 
link:task-manage-data-services-licenses.html[Learn more about managing licenses.]
link:task-manage-subscriptions.html[Learn more about managing subscriptions.]
...
In the Overview dashboard, you can view license and subscription issues that need to be resolved. Issues include licenses and subscriptions that are expiring or reaching capacity.

. From the NetApp Console menu, select *Administration > Licenses and subscriptions*.

. Select *Overview*.

. In the *Requires action* tile, select *Resolve* to view issues that need to be adjusted. If *Resolve* does not display, there are no issues requiring action.  
