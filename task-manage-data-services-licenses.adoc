...
summary: "Manage licenses that you purchased directly from NetApp (BYOL) for use with NetApp data services. You can view used license capacity, capacity usage, and upcoming expirations."
---
...
[.lead]
You can manage licenses that you purchased directly from NetApp (BYOL) for use with NetApp data services, including Cloud Volumes ONTAP. You can view used license capacity, capacity usage, and upcoming expirations.
