...
[NOTE]
You must complete all steps to activate your private offer. Skipping steps may result in billing errors. Accepting and activating the offer multiple times results in double charging. 
