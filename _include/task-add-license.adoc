License information automatically displays in the **Licenses and subscriptions** section if the NetApp Console account associated with the license is also a NetApp Support Site account. If you used a Console account that is not associated with your NSS account, you'll need to manually add a license. 
...
. Select the *Direct licenses* tab.
. Select *Add license*.
