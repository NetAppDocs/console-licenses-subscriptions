...
. From the Console menu, select *Administration* > *Licenses and subscriptions*, and then select the *Direct licenses* tab.
. Select a service name row to expand it. This displays all licenses related to that service. Each expanded row displays detailed information about the licenses, including license ID, serial number, capacity, and expiration date.
