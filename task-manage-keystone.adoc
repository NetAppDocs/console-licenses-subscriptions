...
. For the subscription that you want to link, select image:icon-action.png["An icon that is three side-by-side dots"] and select *Link*.
...
. For the subscription that you want to adjust the capacity, select image:icon-action.png["An icon that is three side-by-side dots"] and select *View detail and edit*.

. Enter the requested committed capacity for one or more subscriptions.

. Scroll down, enter any additional details for the request, and then select *Submit*.
...
. For the subscription that you want to unlink, select image:icon-action.png["An icon that is three side-by-side dots"] and select *Unlink*.
