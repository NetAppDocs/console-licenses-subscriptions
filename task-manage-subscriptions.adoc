...
. From the NetApp Console menu, select *Administration > Licenses and subscriptions*.
. Select *Marketplace Subscriptions*.
. In the row for the subscription you want to associate, open the action menu then select *Associate*.
. In the *Associate the subscription* dialog, select the Console organizations you want to associate with the subscription. 
. Select *Associate*.
...
. In the row for the subscription you want to unconfigure, select the action menu then *Unconfigure*.
...
When you unsubscribe from a subscription in your cloud provider (AWS, Google Cloud, or Azure), the Console shows the subscription status as *Unsubscribed*. When you've unsubscribed from a subscription, you can also remove it from Licenses and subscriptions. 

.Before you begin
* You can only remove subscriptions with a status of *Unsubscribed*. All related settings, data, and configuration must be cleared or reset before removal.
+
If the subscription is still configured, the *Remove* option is not available. 
...
. In the *Remove subscription* dialog, select *Remove* to confirm that you want to remove the subscription.