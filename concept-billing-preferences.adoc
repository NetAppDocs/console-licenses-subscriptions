...
New Cloud Volumes ONTAP deployments automatically inherit the billing mode you define here, which keeps your organization's chargeback model consistent as new systems are added.
